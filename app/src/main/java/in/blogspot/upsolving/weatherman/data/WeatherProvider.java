		...
		switch(match){
			case WEATHER: {
				...
				if (_id > 0) {
					...
					throw new UnsupportedOperationException("Failed to insert row into weather table " + uri);
				}
				break;
			}
			case LOCATION:
				...
				if(_id > 0){
					...
					throw new UnsupportedOperationException("Failed to insert into location table: " + uri);
				}
				break;
			default:
				throw new UnsupportedOperationException("Unknown Uri " + uri);
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch(match){
			...
			case LOCATION:
				...
				break;
			default:
				throw new UnsupportedOperationException("Failed to delete rows " + uri);
		}
	...
	public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
		...
		switch(match){
			...
			case LOCATION:
				...
				break;
			default:
				throw new UnsupportedOperationException("Failed to update the rows " + uri);
		}
	...
	public int bulkInsert(Uri uri, ContentValues[] values) {
		...
		switch (match){
			case WEATHER:
				...
				return returnCount;
			default:
				throw new UnsupportedOperationException("Failed bulk insert " + uri);
		}
